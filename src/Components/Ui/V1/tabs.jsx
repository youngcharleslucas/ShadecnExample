...
function Tabs({ className, orientation = "horizontal", ...props }) {
  return (
    <TabsPrimitive.Root
      ...
      className={cn("theme-v1 flex gap-2 data-[orientation=horizontal]:flex-col", className)}
      {...props}
    />
  )
}
...
const tabsListVariants = cva(
  "theme-v1 inline-flex w-fit items-center justify-center rounded-[var(--radius-full)] p-1 text-muted-foreground group-data-[orientation=horizontal]/tabs:h-10 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
