...
const alertVariants = cva(
  "theme-v2 relative grid w-full grid-cols-[0_1fr] items-start gap-y-0.5 rounded-[var(--radius-large)] border-[length:var(--component-border-width)] border-border px-4 py-3 text-sm has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] has-[>svg]:gap-x-3 [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current",
  {
    variants: {
      variant: {
